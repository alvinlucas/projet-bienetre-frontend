...
const Home = () => {
  return (
    <div className="bg-beige text-green-900">
      ...
      {/* Contenu principal */}
      <main className="flex flex-col justify-center items-center text-center h-[70vh]">
        {" "}
        {/* Réduction de la hauteur */}
        <h1 className="text-5xl font-playfair mb-3">
          Bienvenue sur Respirer Son Bien-Être
        </h1>
        <p className="text-lg font-poppins mb-6 max-w-xl">
          Améliorez votre sérénité et bien-être avec nos cours hebdomadaires en
          ligne, conçus pour s'adapter à votre rythme.
        </p>
      ...
      <section className="py-16 px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="text-center bg-white shadow-lg rounded-lg p-6">
            ...
            <p>
              Des cours hebdomadaires accessibles en ligne depuis n'importe quel
              appareil.
            </p>
          </div>
          <div className="text-center bg-white shadow-lg rounded-lg p-6">
            ...
            <p>
              Pratiquez où vous voulez, quand vous voulez, selon votre emploi du
              temps.
            </p>
          </div>
          <div className="text-center bg-white shadow-lg rounded-lg p-6">
            ...
            <p>
              Profitez d'un suivi personnalisé pour améliorer votre bien-être au
              quotidien.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg font-poppins mb-4">
              Inscrivez-vous en ligne, choisissez votre abonnement, et accédez à
              nos cours hebdomadaires exclusifs. Pratiquez selon votre emploi du
      ...
      <footer className="bg-beige text-center py-2">
        <p className="text-sm font-poppins text-green-900">
          © {new Date().getFullYear()} Respirer Son Bien-Être. Tous droits
          réservés.
        </p>
      </footer>
    </div>
