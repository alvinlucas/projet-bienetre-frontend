        ...
        <div className="h-screen bg-beige flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="w-full max-w-2xl p-8 bg-white rounded-lg shadow-xl mt-4">
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label className="block text-lg font-semibold mb-2 text-green-900">Nom</label>
                        <input
                            type="text"
                            name="nom"
                    ...
                    <div>
                        <label className="block text-lg font-semibold mb-2 text-green-900">Prénom</label>
                        <input
                            type="text"
                            name="prenom"
                            onChange={handleChange}
                    ...
                    <div>
                        <label className="block text-lg font-semibold mb-2 text-green-900">Email</label>
                        <input
                            type="email"
                            name="email"
                            onChange={handleChange}
                    ...
                    <div>
                        <label className="block text-lg font-semibold mb-2 text-green-900">Pseudo</label>
                        <input
                            type="text"
                            name="pseudo"
                            onChange={handleChange}
                    ...
                    <div>
                        <label className="block text-lg font-semibold mb-2 text-green-900">Mot de passe</label>
                        <input
                            type="password"
                            name="password"
                            onChange={handleChange}
